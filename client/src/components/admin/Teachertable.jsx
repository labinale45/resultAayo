...
//update Teacher
 const handleSaveChanges = async () => {
  try {
    ...
    const response = await fetch(`http://localhost:4000/api/auth/teacher/${selectedTeacher.id}`, {
      method: 'PUT',
      headers: {
        'Content-Type': 'application/json',
      },
           ...
           <div className="flex flex-wrap gap-5 items-center w-full max-md:max-w-full mb-10">
             <div className="flex flex-wrap flex-1 shrink gap-5 items-center self-stretch my-auto basis-0 min-w-[240px] max-md:max-w-full">
               ...
               <div className="flex flex-col self-stretch my-auto min-w-[240px]">
                 ...
                 <div className="mt-2 text-sm text-gray-500">Edit Teacher Details</div>
               </div>
             </div>
           </div>
            <div className="grid grid-cols-2 gap-6 mb-10">
             <div id="input" className="relative">
               ...
               />
               <label htmlFor="first_name" className="absolute text-gray-400 -top-4 text-xs left-0 cursor-text peer-focus:text-xs peer-focus:-top-4 transition-all peer-focus:text-blue-700 peer-placeholder-shown:top-1 peer-placeholder-shown:text-sm">
                 First name
               </label>
             </div>
             <div id="input" className="relative">
            ...
            <div className="sm:flex sm:flex-row-reverse flex gap-4">
             ...
             <button
               ...
               type="button"
               onClick={() => { setIsEditing(false); setSelectedTeacher(null); }}
             >
               Cancel
             </button>
           </div>
