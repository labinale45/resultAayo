    ...
    <div className="bg-white dark:bg-[#253553] dark:text-white  text-black  flex rounded-3xl shadow-2xl max-w-3xl p-3 relative">
      ...
      <div className="sm:w-1/2 px=15">
        ...
        <form className="flex flex-col gap-4 mt-6">
          ...
          <button className=" w-32 p-3 ml-24 mt-4 rounded-xl bg-[#7ba0e4] dark:bg-[#8AA4D6] hover:bg-[#4c94ec] dark:hover:bg-[#253553] hover:text-white  text-center  shadow-xl font-bold "
          >
            C R E A T E
          </button>
        </form>
